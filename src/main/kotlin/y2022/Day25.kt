...
//
        ...
        realInput.part1().expecting(39021690220321L)
...
class Template(private val input: String) {
    ...
    fun part1(): Long {
        ...
        // 61,035,156,250 - 39,021,690,220,321
        val sum = listOf("2011-=2=-1020-1===-1").map {
//        val sum = input.lines().map {
            var decimal = 0L
            it.reversed().forEachIndexed { index, c ->
                decimal += chars[c]!! * 5.0.pow(index).toLong()
